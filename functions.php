...
{
    wp_enqueue_style('btg-style', get_template_directory_uri() . '/dist/index.860b4274.css', 1.0);
    // wp_enqueue_script('btg-script', get_template_directory_uri() . '/dist/index.314bee02.js', [], 1.0, false);
    wp_enqueue_script('btg-script', get_template_directory_uri() . '/dist/index.66397e82.js', [], 1.0, true);
}
