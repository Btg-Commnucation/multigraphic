...
{
    wp_enqueue_style('btg-style', get_template_directory_uri() . '/dist/index.8f5aec30.css', 1.0);
    wp_enqueue_script('btg-script', get_template_directory_uri() . '/dist/index.314bee02.js', [], 1.0, false);
    wp_enqueue_script('btg-script', get_template_directory_uri() . '/dist/index.5bea22cd.js', [], 1.0, true);
}
